...
def export_data_set_def(df_src_array):
    ...
    df_data_set_def['test'] = [CODE_TRAIN if x.find('test') < 0 else CODE_TEST for x in
    ...
    df_small_data_set_def = df_data_set_def.loc[(df_data_set_def['data_set_id'].str.contains('_c9'))
                                                | df_data_set_def['data_set_id'].str.contains('_c9')]
