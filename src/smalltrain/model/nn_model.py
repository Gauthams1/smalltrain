...
class NNModel:
    ...
    def restore_model(self):
        ...
        if self.init_model_path is not None:
            ...
            GGPrint.print('[restore_model]has_restored: {}'.format( has_restored))
    ...
    def define_dnn_model(self, n_layer=4):
        ...
        with tf.name_scope('model/'):
            ...
            # GGPrint.print('x_t.shape: {}'.format( x_t.shape))
            x_r = tf.reshape(self.x, [-1, col_size * input_width])
            GGPrint.print('x_r.shape: {}'.format( x_r.shape))
            x_in_layer = x_r
    ...
    def connect_sub_model(self, layer):
        ...
        def build_sub_model(x):
            ...
            GGPrint.print('build_sub_model x after augment_data shape {}'.format( x.shape))
        ...
        if layer.name in [self.sub_model_input_point, '{}:0'.format(self.sub_model_input_point)]:
            ...
            GGPrint.print('sub_model_output shape {}'.format( self.sub_model_output.shape))
